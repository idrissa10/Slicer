...
class ScreenCaptureWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.outputTypeWidget.setToolTip(_("Select how captured images will be saved. Video"
		"mode requires setting of ffmpeg executable path in Advanced section."))
        ...
        self.volumeNodeComboBox.setToolTip(_("Select a volume node to store the captured image in"
		"the scene instead of just writing immediately to disk. Requires output 'Number of images' to be set to 1."))
        ...
        for watermarkPositionPreset in self.logic.watermarkPositionPresets:
            self.watermarkPositionWidget.addItem(watermarkPositionPreset[_("name")])
    ...
    def onCaptureButton(self):
		...
		(self.outputTypeWidget.currentText == _("image series")) else self.logic.getRandomFilePattern()
